...
public class CustomNominatim {
    ...
    public CustomNominatim(Context context, Locale locale, String userAgent){
        mLocale = locale;
        setOptions(false);
    ...
    public CustomNominatim(Context context, String userAgent){
